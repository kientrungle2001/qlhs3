...
class News extends MY_AdminController {
	...
	public $pageNum = 0;
	public $sortBys = [
		['value' => 'news.id desc', 'label' => 'ID giảm'],
		['value' => 'news.id asc', 'label' => 'ID tăng'],
		['value' => 'news.ordering desc', 'label' => 'Thứ tự giảm'],
		['value' => 'news.ordering asc', 'label' => 'Thư tự tăng']
	];
	public $sort = 'news.ordering asc';
	public $sortFields = [
		['index' => 'news.id', 'alias' => 'id', 'label' => 'ID'],
		['index' => 'news.ordering', 'alias' => 'ordering', 'label' => 'Thứ tự'],
		['index' => 'news.name', 'alias' => 'name', 'label' => 'Nội dung'],
	];
