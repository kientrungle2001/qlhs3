				...
				<div class="nobel-list-md choice">
					<div class="row">
						<div class="col-xs-12" ng-show="language != 'vn'">
							<div class="ptnn-title full text-justify" mathjax-bind="formatWritting(question, question.name)"></div>
						</div>
						<div class="col-xs-12" ng-show="language == 'vn' || language == 'ev'">
							<div class="ptnn-title full text-justify" mathjax-bind="formatWritting(question, question.name_vn)"></div>
						</div>
					</div>
