	...
	<div class="container mt-4 mb-3">
		<div class="main-shadow full p-3">
			...
			<div id="guide" class="full bg-light p-3 mb-3">
				...
				<h5 class="text-center t-weight">Phần mềm FullLook giá <span class="label label-danger ">900.000 đồng</span> cho 1 năm sử dụng </h5>
				...
				<p><strong>Bước 2:</strong> Bạn có thể mua phần mềm theo ba cách</p>
					<div class="row">
