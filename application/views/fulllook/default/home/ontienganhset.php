<?php $controller->js('controller/english_test_set_list.js');?>
<div id="ontienganh" class="full" ng-controller="englistTestSetListController">
	<div class="container">
	...
	<div class="container">
		<div class="row" ng-init="selectedEnglishTestPage = 0">
			<div class="col-12 col-sm-4 col-md-3 col-lg-2" ng-repeat="test in englishTests" ng-show="inPage($index, selectedEnglishTestPage, 30)">
