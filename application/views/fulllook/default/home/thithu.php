...
<div id="thithu" class="full" ng-controller="testSetListController">
	<div class="container">
		...
		<img src="/assets/images/hand-right.gif" style="width: 64px; height: auto;" /> {{translate('Tran Dai Nghia Mock Exam')}}
		</div>
	</div>
	<div class="container">
			...
			<div class="col-12 text-center">
				<nav aria-label="Navigation">
					<ul class="pagination justify-content-center">
						<li class="page-item" ng-repeat="page in range(1, totalPage(testSets.length, 15), 1)" ng-click="selectTestSetPage(page-1)" ng-class="{'active': selectedTestSetPage == page-1}"><a href="#" class="page-link" onclick="return false;">{{page}}</a></li>
					</ul>
				</nav>
			</div>
		</div>
