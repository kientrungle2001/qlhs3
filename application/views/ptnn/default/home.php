...
<div class="container" ng-controller="image_controller">
	<div class="row">
		<div class="col-md-10" id="main-content">
			...
			<?php $controller->view('home/featured', $data);?>
			<hr class="hr-separator" />
			<?php $controller->view('home/khoahoc', $data);?>
			<hr class="hr-separator" />
			<?php $controller->view('home/thi24h', $data);?>
			<hr class="hr-separator" />
			<?php $controller->view('home/quatangtritue', $data);?>
