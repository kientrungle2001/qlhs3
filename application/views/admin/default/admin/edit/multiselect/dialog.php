	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ul class="list-group">
					<li class="list-group-item d-flex justify-content-between align-items-center" ng-click="item.<?= $setting['index']?>=[];"><?= $setting['label']?></li>
					<?php
					if(isset($setting['options'])) {
						...
						ng-show="filter_data_keyword.<?= $setting['index']?> == '<?= $option['value']?>' 
						 ...
						 class="list-group-item d-flex justify-content-between align-items-center" 
							ng-class="{'active': item.<?= $setting['index']?>.indexOfMatched('<?= $option['value']?>') != -1}" 
							ng-click="toggleSet(item.<?= $setting['index']?>,'<?= $option['value']?>');"><?= $option['label']?></li>
						<?php 
						}
					}
					?>
					...
					<li ng-show="filter_data_keyword.<?= $setting['index']?> == editItem.id 
							...
							ng-click="toggleSet(item.<?= $setting['index']?>,editItem.<?= $setting['valueField']?>);">
						...
						<div ng-repeat="editItem2 in editItem.children">
							...
							ng-click="toggleSet(item.<?= $setting['index']?>,editItem2.<?= $setting['valueField']?>);">
							...
							ng-click="toggleSet(item.<?= $setting['index']?>,editItem3.<?= $setting['valueField']?>);">
							...
							ng-click="toggleSet(item.<?= $setting['index']?>,editItem4.<?= $setting['valueField']?>);">
							...
							ng-click="toggleSet(item.<?= $setting['index']?>,editItem5.<?= $setting['valueField']?>);">
							...
							ng-click="toggleSet(item.<?= $setting['index']?>,editItem6.<?= $setting['valueField']?>);">
