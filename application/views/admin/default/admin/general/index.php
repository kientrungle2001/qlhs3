<?php 
$grid_view = $controller->get_view_path('grid');
$filters = $controller->filterFields; ?>
...
<div class="container-fluid" ng-controller="adminGridController">
	<div class="row mt-2">
		...
		<div class="col-md-18">
			<div class="card">
				<div class="card-header bg-success text-white">Quản trị <?= $controller->title?></div>
				<div class="card-body">
				<?php $controller->view($grid_view);?>
				</div>
			</div>
		</div>
		<!-- End Grid -->
...
adminApp.controller('adminGridController', [
	'$scope', function($scope) {
		...
		<?php $controller->view($grid_view, ['is_js' => true])?>
